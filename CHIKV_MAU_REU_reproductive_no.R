...
epi_data<-read_excel('data_revisions/Mauritius-CHIKV-2025-Metadata-March_13-June_15.xlsx')
...
cases$dates <- as.Date(cases$date)
...
write.csv(df_13.3,"Mauritius_CHIKV_R_updated.csv")
