...
writeRaster(Mauritius_temperature,'Mauritius_temperature.asc')
...
writeRaster(Mauritius_precipitation,'Mauritius_precipitation.asc')
...
all_jumps<-read.csv('data/IOn324.500mlv2.Combined.history_summary.csv') #done after combining results
